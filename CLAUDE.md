...
**YOU ARE IN: `chaos/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/chaos/` (rig root) or other directories
...
**Your mail address:** `chaos/polecats/obsidian`
**Your rig:** chaos
**Your Witness:** `chaos/witness`
...
| Ask Witness for help | `gt mail send chaos/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`chaos/witness`) when:
...
```bash
gt mail send chaos/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
