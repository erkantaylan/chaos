...
public class ChaosDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ChaosDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ChaosResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Chaos");

            options.DefaultResourceType = typeof(ChaosResource);
        ...
        {
            options.MapCodeNamespace("Chaos", typeof(ChaosResource));
        });
    }
}
